...
class App():
    ...
    def on_remove(self, w):
        ...
        movie = self.builder.get_object("treeview1").get_selection().get_selected()[1]
        ...
        deliminar.get_message_area().get_children()[1].set_label(self.model.get_title(movie))
    ...
    def on_edit(self, w):
        ...
        movie_iter = self.builder.get_object("treeview1").get_selection().get_selected()[1]
        ...
        etitulo.set_text(self.model.get_title(movie_iter))
        eano.set_value(int(self.model.get_year(movie_iter)))
        eduracion.set_value(int(self.model.get_duration(movie_iter)))
        edirector.set_text(self.model.get_director(movie_iter))
        ...
        while True:
            ...
            if r == 0:
                ...
                # Añadir pelicula al modelo
                movie = Movie(titulo, ano, duracion, director)
                self.model.set_movie(movie_iter, movie)
                break
            else:
                break
    ...
    def __init__(self):
        ...
        self.builder.get_object("treeview1").set_model(self.model.listmodel)
